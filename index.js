...
let highScoreBox = document.getElementById('highScoreBoxBox');
let scoreBox = document.getElementById('scoreBoxBox'); 
let scoreBoardScore = document.getElementById('scoreboard-score'); 
let scoreBoardHighScoreBox = document.getElementById('scoreboard-high-score'); 
...
function setSCore(){
    if(score > highScore){
        ...
        scoreBoardHighScoreBox.textContent = highScore;
    }
